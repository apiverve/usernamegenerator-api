# Username Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:usernamegenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.usernamegenerator.UsernameGeneratorAPIClient;
import com.apiverve.usernamegenerator.APIResponse;
import com.apiverve.usernamegenerator.APIException;

// Initialize the client
UsernameGeneratorAPIClient client = new UsernameGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/usernamegenerator](https://docs.apiverve.com/ref/usernamegenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/usernamegenerator](https://docs.apiverve.com/ref/usernamegenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/usernamegenerator-api/issues)
