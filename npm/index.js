...
class usernamegeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/usernamegenerator');
        }
        ...
        this.validationRules = {"email":{"type":"string","required":true,"format":"email"},"count":{"type":"integer","required":false,"min":1,"max":100,"default":1}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/usernamegenerator`);
        }
    }
...
module.exports = usernamegeneratorWrapper;
