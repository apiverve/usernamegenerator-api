// Package usernamegenerator provides a Go client for the Username Generator API.
//
// For more information, visit: https://usernamegenerator.apiverve.com?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/usernamegenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the Username Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Username Generator API client.
...
// Execute makes a request to the Username Generator API with typed parameters.
//
...
//   - email (required): string - The email address to generate usernames from [format: email]
//   - count: integer - The number of usernames to generate [min: 1, max: 100]
