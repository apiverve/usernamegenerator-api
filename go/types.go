...
// Request contains the parameters for the Username Generator API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"count": {Type: "integer", Required: false, Min: float64Ptr(1), Max: float64Ptr(100)},
	}
...
// ResponseData contains the data returned by the Username Generator API.
