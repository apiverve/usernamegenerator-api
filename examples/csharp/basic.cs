...
{
    class UsernameGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/usernamegenerator";

        /// <summary>
        /// Make a GET request to the Username Generator API
        /// </summary>
        static async Task<JsonDocument> CallUsernameGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;email&quot;] &#x3D; &quot;sean@mail.com&quot;, [&quot;count&quot;] &#x3D; 10 };
        ...
        {
            Console.WriteLine("📤 Calling Username Generator API...\n");

            var result = await CallUsernameGeneratorAPI();
